        ...
        <Grid container spacing={2}>
          <Grid className="flex flex-wrap gap-5" item xs={12}>
            ...
            <label htmlFor="fileInput" className="relative">
              ...
              {uploadImage && (
                <div className="absolute right-0 top-0 left-0 bottom-0 w-24 h-24 flex justify-center items-center">
                  <CircularProgress />
                </div>
              )}
            </label>
            <div className="flex flex-wrap gap-2">
              {formik.values.images.map((image, index) => (
                <div className="relative">
                  <img src=" " className="w-24 h-24 object-cover" />
                  <IconButton
                    size="small"
                    sx={{
                      position: "absolute",
