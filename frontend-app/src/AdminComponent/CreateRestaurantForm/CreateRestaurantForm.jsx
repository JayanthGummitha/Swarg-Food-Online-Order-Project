import { AddPhotoAlternate, Twitter } from '@mui/icons-material'
...
const CreateRestaurantForm = () => {
  ...
  const handleImageChange= async (e)=>{
    ...
    setUploadImage(true);
    const image = uploadImageToCloudinary(file);
      ...
      <form onSubmit={formik.handleSubmit} className='space-y-4'>
        <Grid container spacing={2}>
          <Grid className="flex flex-wrap gap-5" item xs={12}>
            ...
            <label htmlFor='fileInput' className='relative'>
              <span className='w-24 h-24 cursor-pointer flex  items-center
               ...
               {
                uploadImage&& <div className='absolute right-0 top-0 left-0 bottom-0 w-24 h-24 flex justify-center items-center' >
          ...
          <Grid item xs={12} lg={6}>
            <TextField fullWidth id="cusineType"
            name="cusineType"
            label="CusineType"
            variant="outlined"
            onChange={formik.handleChange}
